...
def home(request):
    ...
    medicare                                = calculate_medicare(N20,total_expense,q22)
    ...
    branch_payroll_liabilities_total                            = calculate_branch_payroll_liabilities_total(_branch_gross_income,total_expense,q22)
    ...
    branch_payroll_liabilities_total = _calculate_ett +calcuate_Fed_Unemploy+ CA_Unemployment/100 + _calculate_social_security +  medicare
